...
namespace EMS.DAL.RepositoryImp
{
    public class MenuDbContext
    {
        ...
        {
           User user =_db.Database.SqlQuery<User>(string.Format("SELECT F_UserID UserID,F_UserName UserName, F_Password Password FROM T_SYS_Users WHERE F_UserName='{0}'",userName)).First();
