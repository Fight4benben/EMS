    ...
    function _collect() {
        ...
        function initLoad() {
            $("#BtnExec").click(function () {
                ...
                var url = "/api/EPECollect/Collect";
        ...
        function showBuilds(data) {
            ...
            $("#buildinglist").change(function (event) {
                ...
                getDataFromServer("/api/EPECollect", "buildId=" + buildId);
            });
        };
        ...
        function showEnergys(data) {
            ...
            $("#te_CollectBtns button").click(function (event) {//为能源按钮绑定click事件，进行数据加载
                ...
                if (isNotRepeat) {
                    clearData();
                    //发送请求
                    getDataFromServer("/api/EPECollect", "buildId=" + $("#buildinglist").val() + "&energyCode=" +
                        $current.attr('value'));
                }
            });
        };
        ...
        function showTable(data) {
            ...
            $.each(data.data, function (key, val) {
                ...
                rows.push({
                    name: val.name, startValue: val.startValue.toFixed(2),
...
jQuery(document).ready(function ($) {
    ...
    $("#cir_epe_collect").attr("class", "active");
