    ...
    function _ringRatio() {
        ...
        function showBuilds(data) {
            ...
            $("#buildinglist").change(function (event) {
                ...
                //console.log($("#daycalendarBox").val());
                getDataFromServer("/api/ItemRingRatio", "buildId=" + buildId + "&date=" + $("#calendarbox").val());
            });
        };
        ...
        function showTreeview(data) {
            ...
            EMS.DOM.initTreeview(data.treeView, $("#treeview"), {
                ...
                onNodeSelected: function (event, node) {
                    ...
                    getDataFromServer("/api/ItemRingRatio", "buildId=" + buildId + "&formulaId=" + id + "&date=" + $("#calendarbox").val());
                }
            });
...
jQuery(document).ready(function ($) {
    ...
    $("#se_ringratio").attr("class", "active");
